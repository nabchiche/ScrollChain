...
A des fins de test nous avons générer des données synthétiques à l'aide de script python permettant de tester la plus part de fonctionnalité convenablement, seulement les données n'étant pas tout à fait juste avec l'usage théorique qui serai fait de ce réseau social certaine fonctionnalité comme celle qui calcule la fréquence d'interaction hors de son cercle social donne des résultat un peu exagéré avec plus de la moitié des utilisateurs ayant un ratio de 1 c'est à dire qu'il n'interagissent pas avec leur cercle d'amis.
